...
import com.app.notifikazioak.kontrolatzaileak.alertakSortu;
...
public class alertaSortuJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sortuAlertajButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sortuAlertajButton1ActionPerformed(evt);
            }
        });
    ...
    private void sortuAlertajButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_sortuAlertajButton1ActionPerformed
        String izena = alertarenIzenajTextField1.getText();
        String kokapena = kokapenakjList1.getSelectedValue();
        String mota = alertaMotakjList2.getSelectedValue();

        alertakSortu alertak = new alertakSortu();
        alertak.sortuAlertak(izena, kokapena, mota);
    }// GEN-LAST:event_sortuAlertajButton1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(alertaSortuJFrame.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
